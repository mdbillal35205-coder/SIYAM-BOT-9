...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "Siyam") || (event.body.toLowerCase() == "Siyam vai") || (event.body.toLowerCase() == "@Siyamff9 ッ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ SIYAM ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Siyam\n𝐇𝐢𝐬 Facebook I'd \https://www.facebook.com/Acs.58235 তার সাতে যোগা যোগ করবেন WhatsApp :- +01603844329", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@Siyam islam ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "tnx") || (nt.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
   ...
   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>SIYAM AR 𝗯𝗼𝘁", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami Siyam") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হ্যা জান কেমন আছেন..?☺️", threadID);
   };
  mess = "{name}"
